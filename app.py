...
from forms import *
from services.links import set_primary_link_for_artist, set_primary_link_for_venue
...
class PostalCode(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint("country", "code", name="uq_country_code"),
        db.CheckConstraint("char_length(country) = 2", name="chk_country_iso2"),
    )
